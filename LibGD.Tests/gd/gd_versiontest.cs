public static class GlobalMembersGd_versiontest
{
	#if __cplusplus
	#endif
	#define GD_H
	...
	//C++ TO C# CONVERTER TODO TASK: There is no direct equivalent in C# to the following C++ macro:
		GlobalMembersGdtest._gd.gdTestAssert(__FILE__, __LINE__, "assert failed in <%s:%i>\n", (DefineConstants.GD_MAJOR_VERSION == gd.gdMajorVersion()));
	//C++ TO C# CONVERTER TODO TASK: There is no direct equivalent in C# to the following C++ macro:
		GlobalMembersGdtest._gd.gdTestAssert(__FILE__, __LINE__, "assert failed in <%s:%i>\n", (DefineConstants.GD_MINOR_VERSION == gd.gdMinorVersion()));
	//C++ TO C# CONVERTER TODO TASK: There is no direct equivalent in C# to the following C++ macro:
		GlobalMembersGdtest._gd.gdTestAssert(__FILE__, __LINE__, "assert failed in <%s:%i>\n", (DefineConstants.GD_RELEASE_VERSION == gd.gdReleaseVersion()));
	//C++ TO C# CONVERTER TODO TASK: There is no direct equivalent in C# to the following C++ macro:
		GlobalMembersGdtest._gd.gdTestAssert(__FILE__, __LINE__, "assert failed in <%s:%i>\n", (string.Compare(DefineConstants.GD_EXTRA_VERSION, gd.gdExtraVersion()) == 0));

		snprintf(buffer, sizeof(sbyte), "%d.%d.%d%s", DefineConstants.GD_MAJOR_VERSION, DefineConstants.GD_MINOR_VERSION, DefineConstants.GD_RELEASE_VERSION, DefineConstants.GD_EXTRA_VERSION);
	//C++ TO C# CONVERTER TODO TASK: There is no direct equivalent in C# to the following C++ macro:
		GlobalMembersGdtest._gd.gdTestAssert(__FILE__, __LINE__, "assert failed in <%s:%i>\n", (string.Compare("GD_MAJOR_VERSION" "." "GD_MINOR_VERSION" "." "GD_RELEASE_VERSION" DefineConstants.GD_EXTRA_VERSION, gd.gdVersionString()) == 0));
