public static class GlobalMembersBug00193
{
	#if __cplusplus
	#endif
	#define GD_H
	...
	internal static gdImageStruct im;
...
//C++ TO C# CONVERTER TODO TASK: The memory management function 'malloc' has no equivalent in C#:
		...
		ctx.putC = GlobalMembersBug00193.failPutC;
		ctx.putBuf = GlobalMembersBug00193.failPutBuf;
		gd.gdImagePngCtx(im, ctx);
		do
		{
//C++ TO C# CONVERTER TODO TASK: The memory management function 'free' has no equivalent in C#:
			free(ctx);
