public static class GlobalMembersBug00227
{
	#if __cplusplus
	#endif
	#define GD_H
	...
	static int Main()
	{
		...
		im0 = gd.gdImageCreate(DefineConstants.WIDTH, DefineConstants.HEIGHT);
		if (im0 == null)
			return 1;
		for (i = 0; i < DefineConstants.WIDTH; i++)
		{
		...
		gd.gdImageGifAnimAdd(im0, fp, 1, 0, 0, DefineConstants.DELAY, 1, null);

		im1 = gd.gdImageCreate(DefineConstants.WIDTH, DefineConstants.HEIGHT);
		if (im1 == null)
			return 1;
		for (i = 0; i < DefineConstants.WIDTH; i++)
		{
		...
		gd.gdImageGifAnimAdd(im1, fp, 1, 0, 0, DefineConstants.DELAY, 1, im0);

		im2 = gd.gdImageCreate(DefineConstants.WIDTH, DefineConstants.HEIGHT);
		if (im2 == null)
			return 1;
		for (i = 0; i < DefineConstants.WIDTH; i++)
		{
		...
		gd.gdImageGifAnimAdd(im2, fp, 1, 0, 0, DefineConstants.DELAY, 1, im1);
