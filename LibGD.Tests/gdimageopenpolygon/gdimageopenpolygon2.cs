public static class GlobalMembersGdimageopenpolygon2
{
	#if __cplusplus
	#endif
	#define GD_H
...
//C++ TO C# CONVERTER TODO TASK: The memory management function 'calloc' has no equivalent in C#:
		...
		points[1].x = 50;
		points[1].y = 70;
		gd.gdImageOpenPolygon(im, points, 2, black);
	//C++ TO C# CONVERTER TODO TASK: There is no direct equivalent in C# to the following C++ macro:
		r = GlobalMembersGdtest.gd.gdTestImageCompareToFile(__FILE__, __LINE__, null, (DefineConstants.GDTEST_TOP_DIR "/gdimageopenpolygon/gdimageopenpolygon2.png"), (im));
