public static class GlobalMembersGdimagepolygon1
{
	#if __cplusplus
	#endif
	#define GD_H
...
//C++ TO C# CONVERTER TODO TASK: The memory management function 'calloc' has no equivalent in C#:
		...
		points[0].x = 10;
		points[0].y = 10;
		gd.gdImagePolygon(im, points, 1, black);
	//C++ TO C# CONVERTER TODO TASK: There is no direct equivalent in C# to the following C++ macro:
		r = GlobalMembersGdtest.gd.gdTestImageCompareToFile(__FILE__, __LINE__, null, (DefineConstants.GDTEST_TOP_DIR "/gdimagepolygon/gdimagepolygon1.png"), (im));
